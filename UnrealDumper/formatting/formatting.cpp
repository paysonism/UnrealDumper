...
std::string Formatting::GetUPropertySpecifiers(EPropertyFlags Flags) {
	...
	// payson1337 result += (Flags & EPropertyFlags::CPF_Edit) ? "EditAnywhere, " : ""; // payson1337 TODO: Format like this
	...
	// payson1337  EditInline -> deprecated
	...
	// payson1337 RepRetry -> deprecated
	...
	// payson1337 if (VariableCategory != EVariableCategory::Member)
