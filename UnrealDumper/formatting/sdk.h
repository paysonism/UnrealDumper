...
namespace SDKFormatting {
	...
	static std::string GenerateNameStruct() {
		return R"(
	// payson1337 https://github.com/EpicGames/UnrealEngine/blob/c3caf7b6bf12ae4c8e09b606f10a09776b4d1f38/Engine/Source/Runtime/Core/Public/UObject/NameTypes.h#L403
	struct FName
	{
	...
	struct FText {};
)"; // payson1337 I think the size is always 0x10, but we need to improve this...
	}
