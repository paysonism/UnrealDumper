...
// payson1337 Find string ref function by kem0x (and psychopast i think)
...
namespace Memory {
	namespace FortKit {
		...
		// payson1337 Only reason we use this is to make sure a string is 100% not included in the exe, so we
		// payson1337 can try the other method with a new string...
		...
		// payson1337 Doesn't really work...
	...
	// payson1337 TODO: Rewrite all off the stuff before...

	// payson1337 Very simple Pattern Scan
