...
public: // payson1337 We make it public
	uint32_t Value;
};
...
class FName {
	public:
		...
		*/
		 ...
		 */
		static constexpr uint32_t StringBufferSize = NAME_SIZE + 1 + 10; // payson1337 NAME_SIZE includes null-terminator
